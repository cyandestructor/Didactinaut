...
$(document).ready(function(){
     ...
     fetch('http://localhost/api/session/', {
      ...
      fetch('http://localhost/api/categories/', {
               ...
               console.log(data);
               var nav_categories = $("#categorias_antes_de_dropdown");
               ...
               for(var i=5; i < len; i++ ){
                  drop_categories.append('<a class="dropdown-item" href="search-results.html?query=&category='+ data[i].id + 'l">' + data[i].name + '</a>')
               }
          })
